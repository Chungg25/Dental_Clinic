...
namespace Dental_Clinic.GUI.LeTan.ThanhToan
{
    partial class FormThanhToan_ChuyenKhoan
    {
        ...
        private void InitializeComponent()
        {
            ...
            pbDoiQr = new PictureBox();
            ((System.ComponentModel.ISupportInitialize)pbQR).BeginInit();
            ((System.ComponentModel.ISupportInitialize)pbDoiQr).BeginInit();
            SuspendLayout();
            // 
            // pbQR
            // 
            pbQR.Image = Resources.qr;
            pbQR.Location = new Point(114, 45);
            pbQR.Name = "pbQR";
            ...
            // pbDoiQr
            // 
            pbDoiQr.Cursor = Cursors.Hand;
            pbDoiQr.Image = Resources.icons8_edit_64;
            pbDoiQr.Location = new Point(12, 12);
            pbDoiQr.Name = "pbDoiQr";
            pbDoiQr.Size = new Size(45, 45);
            pbDoiQr.SizeMode = PictureBoxSizeMode.Zoom;
            pbDoiQr.TabIndex = 140;
            pbDoiQr.TabStop = false;
            pbDoiQr.Click += pbDoiQr_Click;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)pbDoiQr).EndInit();
            ResumeLayout(false);
        }
