...
namespace Dental_Clinic.GUI.Administrator
{
    partial class UserForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "Quản Lý Bác Sĩ";
            // 
            // vbThemBacSi
            // 
            vbThemBacSi.BackColor = Color.FromArgb(163, 211, 229);
            vbThemBacSi.BackgroundColor = Color.FromArgb(163, 211, 229);
            vbThemBacSi.BorderColor = Color.PaleVioletRed;
            vbThemBacSi.BorderRadius = 8;
            ...
            vbThemBacSi.Font = new Font("Segoe UI Semibold", 13.8F, FontStyle.Bold, GraphicsUnit.Point, 0);
            vbThemBacSi.ForeColor = Color.White;
            vbThemBacSi.Location = new Point(479, 103);
            vbThemBacSi.Name = "vbThemBacSi";
            vbThemBacSi.Size = new Size(212, 57);
            vbThemBacSi.TabIndex = 2;
            vbThemBacSi.Text = "Thêm bác sĩ";
            vbThemBacSi.TextAlign = ContentAlignment.MiddleLeft;
            ...
            pictureBox7.Location = new Point(628, 108);
