...
namespace Dental_Clinic.GUI.Administrator.Supplies
{
    public partial class FormThemVatTu : Form
    {
        ...
        private void vbThemVatTu_Click(object sender, EventArgs e)
        {
            ...
            dichVuDTO.NgayNhap = dtpNgayNhap.Value.ToString("yyyy-MM-dd");
            dichVuDTO.NgaySanXuat = dtpNgaySanXuat.Value.ToString("yyyy-MM-dd");
            dichVuDTO.NgayHetHan = dtpNgayHetHan.Value.ToString("yyyy-MM-dd");
