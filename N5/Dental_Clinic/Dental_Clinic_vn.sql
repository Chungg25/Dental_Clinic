...
BEGIN
    -- Đặt cơ sở dữ liệu về chế độ đơn người dùng và rollback ngay lập tức tất cả các giao dịch đang chạy
...
-- Tạo lại cơ sở dữ liệu DentalClinic
CREATE DATABASE DentalClinic;
GO

-- Chuyển sang sử dụng cơ sở dữ liệu mới tạo
USE DentalClinic;
GO
	...
	ALTER TABLE [ho_so_benh_an] ADD CONSTRAINT FK_HoSoBenhAn_BacSi FOREIGN KEY (ma_bac_si) REFERENCES bac_si(ma_nguoi_dung) ON DELETE CASCADE;


----------------Thêm dữ liệu----------------
-- Thêm dữ liệu vào bảng người dùng
INSERT INTO nguoi_dung
    (ma_nguoi_dung, ho_ten, cccd, so_dien_thoai, dia_chi, gioi_tinh, ngay_sinh, vai_tro, ten_dang_nhap, mat_khau, email, he_so_luong, trang_thai, phien)
VALUES

    (1, N'Nguyễn Văn An', '123456789001', '0901234561', N'123 Lê Lợi, Q1, TP.HCM', 1, '1990-01-15', 'Admin', 'admin1', 'pass123', 'hatrongnguyen04@gmail.com', 1.5, 1, 1
),
    (2, N'Trần Thị Bình', '123456789002', '0901234562', N'456 Nguyễn Huệ, Q1, TP.HCM', 0, '1991-02-20', 'Admin', 'admin2', 'pass123', 'admin2@gmail.com', 1.5, 1, 1),
    (3, N'Lê Văn Cường', '123456789003', '0901234563', N'789 Lê Duẩn, Q1, TP.HCM', 1, '1992-03-25', 'Reception', 'recep1', 'pass123', 'recep1@gmail.com', 1.2, 1, 1),
    (4, N'Phạm Thị Dung', '123456789004', '0901234564', N'147 Nam Kỳ, Q3, TP.HCM', 0, '1993-04-30', 'Reception', 'recep2', 'pass123', 'recep2@gmail.com', 1.2, 1, 1),
    (5, N'Hoàng Văn Em', '123456789005', '0901234565', N'258 Hai Bà Trưng, Q1, TP.HCM', 1, '1994-05-05', 'Reception', 'recep3', 'pass123', 'recep3@gmail.com', 1.2, 1, 1),
    (6, N'Đỗ Thị Phương', '123456789006', '0901234566', N'369 Lê Văn Sỹ, Q3, TP.HCM', 0, '1985-06-10', 'Doctor', 'doctor1', 'pass123', 'hatrongnguyen0423@gmail.com', 2.0, 1, 1),
    (7, N'Vũ Văn Giang', '123456789007', '0901234567', N'147 Nguyễn Đình Chiểu, Q3, TP.HCM', 1, '1986-07-15', 'Doctor', 'doctor2', 'pass123', 'doctor2@gmail.com', 2.0, 1, 1),
    (8, N'Mai Thị Hoa', '123456789008', '0901234568', N'258 Võ Văn Tần, Q3, TP.HCM', 0, '1987-08-20', 'Doctor', 'doctor3', 'pass123', 'doctor3@gmail.com', 2.0, 1, 1),
    (9, N'Trịnh Văn Inh', '123456789009', '0901234569', N'369 Cách Mạng T8, Q3, TP.HCM', 1, '1988-09-25', 'Doctor', 'doctor4', 'pass123', 'doctor4@gmail.com', 2.0, 1, 1),
    (10, N'Lý Thị Kim', '123456789010', '0901234570', N'147 Điện Biên Phủ, Q1, TP.HCM', 0, '1989-10-30', 'Doctor', 'doctor5', 'pass123', 'doctor5@gmail.com', 2.0, 1, 1),
    (11, N'Ngô Văn Linh', '123456789011', '0901234571', N'258 Nguyễn Trãi, Q5, TP.HCM', 1, '1990-11-05', 'Doctor', 'doctor6', 'pass123', 'doctor6@gmail.com', 2.0, 1, 1),
    (12, N'Phan Thị Mai', '123456789012', '0901234572', N'369 Lý Thường Kiệt, Q10, TP.HCM', 0, '1991-12-10', 'Doctor', 'doctor7', 'pass123', 'doctor7@gmail.com', 2.0, 1, 1),
    (13, N'Đặng Văn Nam', '123456789013', '0901234573', N'147 Bà Hom, Q6, TP.HCM', 1, '1992-01-15', 'Doctor', 'doctor8', 'pass123', 'doctor8@gmail.com', 2.0, 1, 1),
    (14, N'Bùi Thị Oanh', '123456789014', '0901234574', N'258 Hùng Vương, Q5, TP.HCM', 0, '1993-02-20', 'Doctor', 'doctor9', 'pass123', 'doctor9@gmail.com', 2.0, 1, 1),
    (15, N'Hồ Văn Phát', '123456789015', '0901234575', N'369 Tân Kỳ Tân Quý, Q.TB, TP.HCM', 1, '1994-03-25', 'Doctor', 'doctor10', 'pass123', 'doctor10@gmail.com', 2.0, 1, 1),
    (16, N'Trương Thị Quỳnh', '123456789016', '0901234576', N'147 Âu Cơ, Q.TB, TP.HCM', 0, '1995-04-30', 'Reception', 'recep4', 'pass123', 'recep4@gmail.com', 1.2, 1, 1),
    (17, N'Lương Văn Rồng', '123456789017', '0901234577', N'258 Lạc Long Quân, Q11, TP.HCM', 1, '1996-05-05', 'Reception', 'recep5', 'pass123', 'recep5@gmail.com', 1.2, 1, 1),
    (18, N'Dương Thị Sen', '123456789018', '0901234578', N'369 Hòa Bình, Q.TB, TP.HCM', 0, '1997-06-10', 'Reception', 'recep6', 'pass123', 'recep6@gmail.com', 1.2, 1, 1),
    (19, N'Lại Văn Tâm', '123456789019', '0901234579', N'147 Trường Chinh, Q12, TP.HCM', 1, '1998-07-15', 'Admin', 'admin3', 'pass123', 'admin3@gmail.com', 1.5, 1, 1),
    (20, N'Châu Thị Uyên', '123456789020', '0901234580', N'258 Quang Trung, Q.GV, TP.HCM', 0, '1999-08-20', 'Admin', 'admin4', 'pass123', 'admin4@gmail.com', 1.5, 1, 1);
/*DELETE FROM [users];
...
-- Thêm dữ liệu vào bảng ho_so_benh_an với cột ngay_lap và ma_bac_si
INSERT INTO ho_so_benh_an
    (chan_doan, phuong_phap_dieu_tri, trieu_chung, ma_benh_nhan, ngay_lap, ma_bac_si)
VALUES
    (N'Sâu răng', N'Điều trị bằng thuốc', N'Đau nhức, cảm thấy khó chịu', 1, '2023-10-01', 6),
    (N'Viêm nướu', N'Tẩy sạch và kê đơn thuốc', N'Sưng nướu, chảy máu khi đánh răng', 2, '2023-10-02', 7),
    (N'Hơi thở có mùi', N'Tư vấn vệ sinh răng miệng', N'Khó chịu, mùi hôi', 3, '2023-10-03', 8),
    (N'Sâu răng nghiêm trọng', N'Nhổ răng', N'Đau nhức, không ăn được', 4, '2023-10-04', 9),
    (N'Răng khôn', N'Nhổ răng khôn', N'Đau ở vùng răng khôn', 5, '2023-10-05', 10),
    (N'Tiêu xương hàm', N'Ghép xương', N'Không có dấu hiệu rõ ràng', 6, '2023-10-06', 11),
    (N'Hypersensitivity', N'Sử dụng kem đánh răng cho răng nhạy cảm', N'Đau nhức khi ăn đồ lạnh', 7, '2023-10-07', 12),
    (N'Khô miệng', N'Tư vấn và điều trị', N'Miệng khô, khó chịu', 8, '2023-10-08', 13),
    (N'Khối u miệng', N'Phẫu thuật', N'Khó nuốt, đau', 9, '2023-10-09', 14),
    (N'Viêm xoang hàm', N'Điều trị bằng thuốc', N'Đau hàm, nhức đầu', 10, '2023-10-10', 15),
    (N'Tiểu đường', N'Tư vấn về chế độ ăn', N'Khát nước, tiểu nhiều', 11, '2023-10-11', 6),
    (N'Trẻ em bị sâu răng', N'Điều trị bằng thuốc và hướng dẫn', N'Đau nhức, khó chịu', 12, '2023-10-12', 7),
    (N'Viêm họng', N'Tư vấn điều trị', N'Đau họng, khó nuốt', 13, '2023-10-13', 8),
    (N'Viêm quanh răng', N'Điều trị bằng thuốc và vệ sinh', N'Sưng nướu, đau nhức', 14, '2023-10-14', 9),
    (N'Chấn thương răng', N'Khám và điều trị', N'Đau nhức, sưng', 15, '2023-10-15', 10),
    (N'Sâu răng và viêm nướu', N'Điều trị kết hợp', N'Đau nhức, chảy máu', 16, '2023-10-16', 11),
    (N'Hơi thở có mùi hôi', N'Tư vấn vệ sinh', N'Mùi hôi miệng', 17, '2023-10-17', 12),
    (N'Răng nhạy cảm', N'Sử dụng sản phẩm phù hợp', N'Đau nhức khi ăn', 18, '2023-10-18', 13),
    (N'Tình trạng răng miệng không tốt', N'Tư vấn điều trị', N'Tình trạng tổng quát xấu', 19, '2023-10-19', 14),
    (N'Chấn thương hàm', N'Điều trị bằng thuốc và phẫu thuật', N'Đau nhức, sưng hàm', 20, '2023-10-20', 15);
...
BEGIN
    ...
    BEGIN
        ...
        FROM nguoi_dung
        WHERE ten_dang_nhap = @username AND mat_khau = @password and phien = 1;
		update nguoi_dung
		set phien = 0
		where ma = @id
    END
...
BEGIN
    ...
    FROM
        ...
        LEFT JOIN ho_so_benh_an AS hs ON bn.ma_benh_nhan = hs.ma_benh_nhan 
            AND hs.ma_bac_si = @ma_bac_si
            AND hs.ngay_lap = @ngay_hien_tai
    WHERE
        lh.ma_nguoi_dung = @ma_bac_si
        AND lh.ngay_hen = @ngay_hien_tai;
END;
GO

--Exec LayThongTinBenhNhanCuaBacSi 6, '2024-11-03'	
...
BEGIN
    ...
    from nguoi_dung
        ...
        join luong on nguoi_dung.ma_nguoi_dung = luong.ma_nguoi_dung
    WHERE (lich_lam_viec.ngay BETWEEN @StartOfMonth AND @EndOfMonth) AND cham_cong.ghi_chu = N'Làm việc đúng giờ' AND lich_lam_viec.ngay = cham_cong.ngay
        AND (luong.ngay BETWEEN @StartOfMonth AND @EndOfMonth) AND nguoi_dung.trang_thai = 1 AND nguoi_dung.ma_nguoi_dung = @id
    GROUP BY nguoi_dung.ho_ten, nguoi_dung.gioi_tinh, nguoi_dung.email, nguoi_dung.ma_nguoi_dung,
	luong.luong_co_ban, luong.thuong, luong.phat, luong.phu_cap, nguoi_dung.he_so_luong
    order by nguoi_dung.ma_nguoi_dung
END;
GO
-- exec ThongTinLeTanTheoThang 6, '2024-10-1', '2024-10-31'
go
CREATE PROCEDURE ThemHoSoBenhAnVaCapNhatTrangThaiKham
    @MaBenhNhan INT,
    ...
    @NgayLap DATE,
    @MaBacSi INT,
    @MaLichHen INT  -- ID của lịch hẹn cần cập nhật trạng thái
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        -- 1. Thêm hồ sơ bệnh án mới
        INSERT INTO ho_so_benh_an
            (ma_benh_nhan, chan_doan, phuong_phap_dieu_tri, trieu_chung, ngay_lap, ma_bac_si)
        VALUES
            (@MaBenhNhan, @ChanDoan, @PhuongPhapDieuTri, @TrieuChung, @NgayLap, @MaBacSi);

        -- 2. Cập nhật trạng thái thành 'đã khám' cho lịch hẹn
        UPDATE lich_hen
        SET trang_thai = 1
        WHERE ma_lich_hen = @MaLichHen AND ma_benh_nhan = @MaBenhNhan;

        -- Xác nhận giao dịch nếu mọi thao tác thành công
        COMMIT TRANSACTION;
    END TRY
    BEGIN CATCH
...
CREATE PROCEDURE ThemLichHen
    ...
    @NgayHen DATE,
    @Ca INT,
    @MaNguoiDung INT,                   -- Mã bác sĩ phụ trách
    @MaBenhNhan INT                      -- Mã bệnh nhân
AS
BEGIN
    SET NOCOUNT ON;

    -- Thêm một lịch hẹn mới vào bảng `lich_hen`
    INSERT INTO lich_hen (ghi_chu, trang_thai, ngay_hen, ca, ma_nguoi_dung, ma_benh_nhan)
    VALUES (@GhiChu, 0, @NgayHen, @Ca, @MaNguoiDung, @MaBenhNhan);
END;
GO

CREATE PROCEDURE LayTatCaLoaiDichVu
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SELECT 
        ma_loai_dich_vu,
        ten_ten_dich AS ten_loai_dich_vu
    FROM 
        loai_dich_vu
    ORDER BY 
        ma_loai_dich_vu;  -- Sắp xếp theo tên loại dịch vụ
END;
GO

CREATE PROCEDURE LayDanhSachDichVuTheoLoai
    @MaLoaiDichVu INT  -- Mã loại dịch vụ để lọc
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM 
        dich_vu
    WHERE 
        ma_loai = @MaLoaiDichVu
    ORDER BY 
        ten;  -- Sắp xếp theo tên dịch vụ
END;
GO
...
CREATE TRIGGER trgTruSoLuongKhiThemChiTietHoaDon
ON chi_tiet_don_thuoc
AFTER INSERT
AS
BEGIN
    SET NOCOUNT ON;

    -- Giảm số lượng trong kho dựa trên thông tin trong bảng chi_tiet_don_thuoc
    UPDATE htk
    SET htk.so_luong = htk.so_luong - ct.so_luong
    FROM hang_ton_kho htk
    JOIN inserted ct ON htk.ma_kho = ct.ma_kho;

    -- Kiểm tra nếu số lượng trong kho sau khi trừ nhỏ hơn 0
    IF EXISTS (
        SELECT 1
        FROM hang_ton_kho
        WHERE so_luong < 0
...
CREATE PROCEDURE ThemHoaDon
    ...
    @ngay DATE,
    @DanhSachThuoc NVARCHAR(MAX),  -- JSON chuỗi cho danh sách thuốc
    @DanhSachDichVu NVARCHAR(MAX)  -- JSON chuỗi cho danh sách dịch vụ
AS
BEGIN
    DECLARE @maHoaDon INT;
    DECLARE @maDonThuoc INT;
    DECLARE @tongGia FLOAT = 0;

    -- Bắt đầu transaction
    BEGIN TRANSACTION;

    BEGIN TRY
        -- 1. Tạo đơn thuốc mới và lấy `ma_don_thuoc`
        SELECT @maDonThuoc = ISNULL(MAX(ma_don_thuoc), 0) + 1 FROM don_thuoc;
        
        INSERT INTO don_thuoc (ma_don_thuoc, ngay, ma_benh_nhan, ma_nguoi_dung)
        VALUES (@maDonThuoc, @ngay, @maBenhNhan, @maBacSi);

        -- 2. Xử lý danh sách thuốc từ JSON để tính tổng giá
        DECLARE @giaThuoc DECIMAL(18, 2);
        DECLARE @maKhoThuoc INT;

        -- Sử dụng OPENJSON để lấy dữ liệu thuốc từ JSON và tính tổng giá
        SELECT @tongGia += SUM(htk.gia * Thuoc.soLuong)
        FROM OPENJSON(@DanhSachThuoc) 
            WITH (tenThuoc NVARCHAR(255), soLuong INT) AS Thuoc
        JOIN hang_ton_kho htk ON htk.ten = Thuoc.tenThuoc;

        -- 3. Xử lý danh sách dịch vụ từ JSON để tính tổng giá
        DECLARE @giaDichVu DECIMAL(18, 2);

        -- Sử dụng OPENJSON để lấy dữ liệu dịch vụ từ JSON và tính tổng giá
        SELECT @tongGia += SUM(dv.gia * DichVu.soLuong)
        FROM OPENJSON(@DanhSachDichVu) 
            WITH (tenDichVu NVARCHAR(255), soLuong INT) AS DichVu
        JOIN dich_vu dv ON dv.ten = DichVu.tenDichVu;

        -- 4. Thêm hóa đơn vào bảng `hoa_don`
        -- Lưu ý: Thêm hóa đơn vào bảng `hoa_don` trước khi thêm chi tiết để tránh vi phạm khóa ngoại
        SELECT @maHoaDon = ISNULL(MAX(ma_hoa_don), 0) + 1 FROM hoa_don;

        INSERT INTO hoa_don (ma_hoa_don, phuong_thuc_thanh_toan, tong_gia, ma_don_thuoc, ma_benh_nhan, ngay, trang_thai_thanh_toan)
        VALUES (@maHoaDon, @phuongThucThanhToan, @tongGia, @maDonThuoc, @maBenhNhan, @ngay, 0);

        -- 5. Thêm chi tiết thuốc vào bảng `chi_tiet_don_thuoc`
        INSERT INTO chi_tiet_don_thuoc (ma_don_thuoc, ma_kho, so_luong, thoi_gian, lieu_luong, tan_suat, ghi_chu)
        SELECT @maDonThuoc, htk.ma_kho, Thuoc.soLuong, 0, 0, 0, N'Chi tiết thuốc'
        FROM OPENJSON(@DanhSachThuoc) 
            WITH (tenThuoc NVARCHAR(255), soLuong INT) AS Thuoc
        JOIN hang_ton_kho htk ON htk.ten = Thuoc.tenThuoc
        WHERE htk.gia IS NOT NULL;

        -- 6. Thêm chi tiết dịch vụ vào bảng `chi_tiet_hoa_don`
        INSERT INTO chi_tiet_hoa_don (ma_hoa_don, ma_dich_vu, so_luong, gia_don_vi)
        SELECT @maHoaDon, dv.ma_dich_vu, DichVu.soLuong, dv.gia
        FROM OPENJSON(@DanhSachDichVu) 
            WITH (tenDichVu NVARCHAR(255), soLuong INT) AS DichVu
        JOIN dich_vu dv ON dv.ten = DichVu.tenDichVu
        WHERE dv.gia IS NOT NULL;
    ...
    BEGIN CATCH
        ...
        -- Trả về lỗi để dễ dàng xác định
        THROW;
    END CATCH;
END;
GO
