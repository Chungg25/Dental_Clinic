...
if __name__ == "__main__":
    ...
    directory = "images"
    # cascade_classifier_filename = "C:/Users/Nguyen/Desktop/Dental_Clinic/real-time-face-recognition/haarcascade_frontalface_default.xml"
    # names_json_filename = "C:/Users/Nguyen/Desktop/Dental_Clinic/real-time-face-recognition/names.json"

    cascade_classifier_filename = os.path.join(
        base_path, "haarcascade_frontalface_default.xml"
    )
    names_json_filename = os.path.join(base_path, "names.json")
    images_directory = os.path.join(base_path, "images")
    ...
    while True:
        ...
        for x, y, w, h in faces:
            ...
            cv2.imwrite(
                # f"C:/Users/Nguyen/Desktop/Dental_Clinic/real-time-face-recognition/images/Users-{face_id}-{count}.jpg",
                os.path.join(images_directory, f"Users-{face_id}-{count}.jpg"),
                gray[y : y + h, x : x + w],
            )
